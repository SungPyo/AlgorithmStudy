...
class JH: UIViewController, Embedded {
    
    static func getController() -> UIViewController {
        let st = UIStoryboard(name: "Main", bundle: Bundle(identifier: "com.castielticket.JH"))
        let vc = st.instantiateViewController(withIdentifier: "JH") as! JH
        return vc
    }
